...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarExample01">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://api.whatsapp.com/send/?phone=917075190199&text=Hi&app_absent=0" target="_blank">Contact</a>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Reports are auto generated by the UI. All are updated by every second. We provide
                                    all necessary information and We have flexible operations. Finally, forget about the
                                    reports.
                                </p>
                                <a href="#!" class="btn btn-outline-secondary">Visit</a>
                            </div>
    ...
    <footer class="bg-light text-lg-start">
        ...
        <div class="text-center">
            <a id="footer-anchor" href="/terms-and-conditions">Terms of Service</a>
            <a id="footer-anchor" href="/privacy-policy">Privacy Statement</a>
